...
void USART1_Send_N_Byte(u8 *byte , int len); //! 串口1发送N个字节数据
void USART2_Send_N_Byte(u8 *byte , int len); //! 串口2发送N个字节数据
void USART3_Send_N_Byte(u8 *byte , int len); //! 串口3发送N个字节数据
